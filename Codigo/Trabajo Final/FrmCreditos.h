...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->label1->Size = System::Drawing::Size(340, 22);
			this->label1->TabIndex = 0;
			this->label1->Text = L"Trabajo Final de CC67 Programación II";
			// 
			// label2
			// 
			...
			this->label2->Font = (gcnew System::Drawing::Font(L"Arial", 14.25F, System::Drawing::FontStyle::Regular, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(0)));
			this->label2->Location = System::Drawing::Point(22, 75);
			this->label2->Name = L"label2";
			this->label2->Size = System::Drawing::Size(132, 22);
			this->label2->TabIndex = 1;
			this->label2->Text = L"Realizado por:";
			// 
			// label3
			// 
			...
			this->label3->Size = System::Drawing::Size(328, 18);
			this->label3->TabIndex = 2;
			this->label3->Text = L"Prado Chumbes, Mauricio Jesús u202010482";
			// 
			// label4
			// 
			...
			this->label4->Font = (gcnew System::Drawing::Font(L"Arial", 12, System::Drawing::FontStyle::Regular, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(0)));
			this->label4->Location = System::Drawing::Point(22, 166);
			this->label4->Name = L"label4";
			this->label4->Size = System::Drawing::Size(325, 18);
			this->label4->TabIndex = 3;
			this->label4->Text = L"Poma Nacarino, Diego Eduardo u202012338";
			// 
			// label5
			// 
			...
			this->label5->Font = (gcnew System::Drawing::Font(L"Arial", 12, System::Drawing::FontStyle::Regular, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(0)));
			this->label5->Location = System::Drawing::Point(22, 210);
			this->label5->Name = L"label5";
			this->label5->Size = System::Drawing::Size(279, 18);
			this->label5->TabIndex = 4;
			this->label5->Text = L"Luna Morales, Gianfranco u201824343";
			// 
			// FrmCreditos
			// 
			this->AutoScaleDimensions = System::Drawing::SizeF(6, 13);
			this->AutoScaleMode = System::Windows::Forms::AutoScaleMode::Font;
			this->ClientSize = System::Drawing::Size(435, 240);
